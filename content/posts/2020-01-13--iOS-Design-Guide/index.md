...
*Note*: Don't replace systemwide status bar with a custom one.
...
*Note*: Use Tab Bars strictly for navigation purpose only. Check Toolbars for other purposes. 
